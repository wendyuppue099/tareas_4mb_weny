...
button_1 = customtkinter.CTkButton(app, text="Presiona para cambiar la forma", command=button_callback)
button_1.pack(pady=10)

frame_1 = customtkinter.CTkFrame(app)
frame_1.pack(pady=10)

label_1 = customtkinter.CTkLabel(app, fg_color="gold")
label_1.pack(pady=10)

entry_1 = customtkinter.CTkEntry(app, placeholder_text="Marcador")
